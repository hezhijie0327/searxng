...
import { Card, CategoryTab, GroupHeader, Select, SettingRow, Switch } from "@/pages/preferences/parts.tsx";
...
export function GeneralTab({
  ...
  return (
    <Card>
      {showSearch ? (
        <Fragment>
          <GroupHeader label={t("general_group_search")} />
          {!locked.has("categories") ? (
      ...
      {showInput ? (
        <Fragment>
          <GroupHeader label={t("general_group_input")} />
      ...
      {showRequests ? (
        <Fragment>
          <GroupHeader label={t("general_group_requests")} />
          {!locked.has("results_on_new_tab") ? (
            <SettingRow
